...
I built Garden MCP as a Go server running on my small DigitalOcean Droplet, protect with auth guard via API key (bearer token). Simple enough to only allow me and my Claude Code to access it.
